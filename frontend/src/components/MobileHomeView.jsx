...
import { Upload, FolderOpen, Music2, Play, Disc, User, RotateCw } from "lucide-react";
...
export function MobileHomeView({
  tracks, currentTrack, likedIds, onPlay, onLoadFiles, onLoadFolder, onRefresh, onSelectArtist,
}) {
    ...
    <div className="flex flex-col h-full overflow-y-auto" style={{ background: "#121212" }}>
      ...
      <div className="px-4 pt-12 pb-2 flex items-center justify-between">
        ...
        {onRefresh && (
          ...
          >
            <RotateCw size={18} style={{ color: "#a7a7a7" }} />
          </button>
        )}
      </div>
...
// ===== NUEVA SECCIÓN: ARTISTAS =====
function ArtistSection({ artists, tracks, currentTrack, onPlay, onSelectArtist }) {
  return (
    <div className="mb-6">
      <div className="flex items-center justify-between px-4 mb-3">
