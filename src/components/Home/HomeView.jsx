...
export default function HomeView({
  ...
  return (
    <div className="flex flex-col gap-4 w-full" style={{ paddingBottom: '140px' }}>
      ...
      <RecommendationsSection songs={allSongsFromServer} likedIds={likedIds} onLike={onLike} onDislike={onDislike} onDislikeArtist={onDislikeArtist} onDelete={onDelete} favoriteArtists={favArtists} />
